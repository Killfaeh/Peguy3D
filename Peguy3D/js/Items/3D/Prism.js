...
//function Prism($radius1, $radius2, $height, $angle, $deltaX, $deltaY, $thetaResolution, $fill, $bottomClosed, $topClosed)
function Prism($radius1, $radius2, $height, $thetaResolution)
{
	///////////////
	// Attributs //
	///////////////
    ...
    this.compute3D = function()
    {
        ...
        if (!utils.isset(glObject))
        {
            ...
            var object = new GLPrism(radius1, radius2, height, angle, deltaX, deltaY, thetaResolution, heightResolution, fill, bottomClosed, topClosed, radiusResolution);
    ...
    this.clone = function()
	{
		var clone = new Prism(radius1, radius2, height, angle, deltaX, deltaY, fill, bottomClosed, topClosed);
