function VectorialAssetsManager()
{
	///////////////
	// Attributs //
	///////////////

	var popupHTML = '<h2>Vectors assets library</h2>'
	...
	var saveAssets = function()
	{
		...
		window.electronAPI.saveVectorialAssets(JSON.stringify(jsonObject));
	};
...
if (Loader !== null && Loader !== undefined)
	Loader.hasLoaded("vectorialsAssetsManager");