function ViewManager()
{
	...
	var itemExportCOLLADA = new MenuItem("To Collada (.dae) file...");
	...
	var itemInsertDoc = new MenuItem("Insert other document...");
	...
	this.init = function()
	{
		...
		itemExport.addElement(itemExportCOLLADA);
		...
		//menuBarItemAssets.addElement(itemInsertDoc);
	...
	this.refresh = function()
	{
		...
		if (utils.isset(selectedTab))
		{
			selectedTab.getContent().refresh();
			selectedTab.getContent().updateStat();
		}
	};
	...
	itemExportCOLLADA.onAction = async function()
	{
		console.log("Export to DAE...");

		var selectedTab = tabManager.getSelected();

		if (utils.isset(selectedTab))
		{
			var colladaData = selectedTab.getContent().getCOLLADAdata();

			const file = await window.electronAPI.exportToCOLLADA(colladaData);
	...
	itemInsertDoc.onAction = function()
	{
		console.log("Insert other document...");
	};
